...
/**
 * ClinicalHistoryEntry MyBatis-Plus Mapper，复用 BaseMapper 减少重复 CRUD SQL。
 */
@Mapper
public interface ClinicalHistoryEntryMapper extends BaseMapper<ClinicalHistoryEntry> {
}
