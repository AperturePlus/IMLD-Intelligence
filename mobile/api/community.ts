...
export const listBoards = (params?: { status?: string; diseaseScope?: string }): Promise<any> =>
  request({
...
export const likePost = (postId: number | string, tocUserId: number | string): Promise<any> =>
  request({
...
export const unlikePost = (postId: number | string, tocUserId: number | string): Promise<any> =>
  request({
    url: `/api/v1/app/community/posts/${postId}/likes`,
    method: 'delete',
    params: { tocUserId }
...
export const bookmarkPost = (postId: number | string, tocUserId: number | string): Promise<any> =>
  request({
...
export const unbookmarkPost = (postId: number | string, tocUserId: number | string): Promise<any> =>
  request({
    url: `/api/v1/app/community/posts/${postId}/bookmarks`,
    method: 'delete',
    params: { tocUserId }
