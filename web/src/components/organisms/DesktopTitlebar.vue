        ...
        >
          ...
          <svg v-else width="12" height="12" viewBox="0 0 12 12">
            ...
            <rect
              ...
              stroke="currentColor"
              stroke-width="1.2"
              fill="var(--electron-titlebar-bg, var(--imld-white))"
            />
          </svg>
        </button>
        <button
...
.brand-indicator {
  ...
  height: 10px;
  border-radius: 50%;
  background: linear-gradient(135deg, var(--imld-teal-1), var(--imld-teal-2));
...
.wc-btn {
  ...
  border: 0;
  background: transparent;
  color: var(--imld-text-quaternary);
  cursor: pointer;
...
.wc-btn--close:hover {
  background: var(--imld-danger-hover);
  color: var(--imld-white);
}
.wc-btn--close:active {
  background: var(--imld-danger-active);
}
