    ...
    <el-row :gutter="20" class="full-height">
      ...
      <el-col :span="18" class="full-height">
        ...
        >
          ...
          <div
            v-else-if="selectedPatient && !diagnosisResult"
            class="ready-state"
          >
            <PatientAvatar
              :size="80"
          ...
          <div v-else-if="diagnosisResult" class="result-state">
            <div class="result-header">
              <div class="title-area">
                <el-icon color="#409EFF" :size="28" style="margin-right: 12px"
                  ><Aim
                /></el-icon>
            ...
            <el-row :gutter="24" class="core-conclusion">
              <el-col
                :span="8"
                style="text-align: center; border-right: 1px solid #ebeef5"
              >
              ...
              <el-col :span="16" style="padding-left: 30px">
                ...
                >
                  ...
                  <el-descriptions-item
                    v-if="diagnosisResult.confidence.visible"
                    label="数据置信度"
                  >
                    <el-tag :type="confidenceTagType" size="small">{{
                      diagnosisResult.confidence.label
                    }}</el-tag>
                  </el-descriptions-item>
                  <el-descriptions-item label="关键证据" :span="2">
                    <div class="key-sign-list">
                      ...
                      <span v-if="diagnosisResult.keySigns.length === 0"
                        >--</span
                      >
                    </div>
                  </el-descriptions-item>
                ...
                <div class="evidence-summary">
                  <el-tag type="info" effect="plain"
                    >纳入模型特征
                    {{
                      diagnosisResult.evidenceSummary.modelFeatureCount
                    }}
                    项</el-tag
                  >
                  <el-tag type="warning" effect="plain"
                    >异常证据
                    {{
                      diagnosisResult.evidenceSummary.abnormalEvidenceCount
                    }}
                    项</el-tag
                  >
                  <el-tag :type="reviewTagType" effect="plain">
                    {{
                      diagnosisResult.evidenceSummary.reviewRequired
                        ? "需医生复核"
                        : "置信度达标"
                    }}
                  </el-tag>
            ...
            <div
              v-if="diagnosisResult.evidenceItems.length > 0"
              class="section-card evidence-card"
            >
              ...
              <div class="evidence-grid">
                ...
                >
                  <div class="evidence-item-top">
                    ...
                    <span v-if="item.source" class="evidence-source">{{
                      item.source
                    }}</span>
                  </div>
                  <div class="evidence-label">{{ item.label }}</div>
                  <div v-if="item.value" class="evidence-value">
                    {{ item.value }}
                  </div>
                </div>
              </div>
            ...
            <div class="section-card">
              ...
              <div class="chart-container">
                <div
                  class="chart-row"
                  v-for="item in diagnosisResult.indicators"
                  :key="item.name"
                >
                ...
                <el-empty
                  v-if="diagnosisResult.indicators.length === 0"
                  description="暂无结构化生化指标"
                  :image-size="80"
                />
              </div>
            </div>
            ...
            <el-row :gutter="20" style="margin-top: 20px">
              <el-col :span="12">
                <div class="section-card suggestion-card">
                  ...
                  <div class="gene-tags">
                    <el-tag
                      v-for="gene in diagnosisResult.genes"
                      :key="gene"
                      type="danger"
                      effect="light"
                      class="gene-tag"
                    ...
                    <el-text
                      v-if="diagnosisResult.genes.length === 0"
                      type="info"
                      size="small"
                    >
                      暂无明确高风险基因变异
...
const reviewTagType = computed(() => {
  return diagnosisResult.value?.evidenceSummary.reviewRequired
    ? "warning"
    : "success";
});
